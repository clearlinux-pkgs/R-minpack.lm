...
Version  : 1.2.2
Release  : 43
URL      : https://cran.r-project.org/src/contrib/minpack.lm_1.2-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/minpack.lm_1.2-2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649863851
